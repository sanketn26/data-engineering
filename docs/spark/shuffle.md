...
aggregate twice, and the whale's 760 GB becomes sixteen reducers of ~48 GB.
The job is back under twenty minutes.
...
whale — which is why the p95 job stayed slow a week longer than the byte
counts did.
