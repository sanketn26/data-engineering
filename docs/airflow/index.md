...
It was **C**. Not more retries — retries on a non-idempotent step are what
wrote 40% of the partition twice. Not a bigger box — cron was never short of
CPU. What was missing is a system of record: one place that knows which of the
25 tasks ran, in what order, against which partition, and what each one
depended on.
...
This is [SaaSCo Stage 5](../architectures/saasco-evolution.md#stage-5-100-workflows-airflow-appears-phase-5),
